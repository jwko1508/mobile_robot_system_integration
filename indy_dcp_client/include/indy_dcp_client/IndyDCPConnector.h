...
#include "indy_dcp_client/IndyDCPUtility.h"
#include "indy_dcp_client/IndyDCPException.h"
...
//	int setJointBlendingLevel(int level);		//DEPRECATED
//	int setTaskBlendingLevel(int level);		//DEPRECATED
...
//	int getJointBlendingLevel(int & ret);		//DEPRECATED
//	int getTaskBlendingLevel(int & ret);		//DEPRECATED
