...
//int IndyDCPConnector::setJointBlendingLevel(int level)
//{
//	INDY_DCP_CHECK_LEVEL(level, 1, 9);
//	INDY_DCP_EXEC_CMD_REQ_VAR(CMD_SET_JOINT_BLEND_RADIUS_LEVEL, int, level);
//}
//
//int IndyDCPConnector::setTaskBlendingLevel(int level)
//{
//	INDY_DCP_CHECK_LEVEL(level, 1, 9);
//	INDY_DCP_EXEC_CMD_REQ_VAR(CMD_SET_TASK_BLEND_RADIUS_LEVEL, int, level);
//}
...
//int IndyDCPConnector::getJointBlendingLevel(int & ret)
//{
//	INDY_DCP_EXEC_CMD_RES_VAR(CMD_GET_JOINT_BLEND_RADIUS_LEVEL, int, ret);
//}
//
//int IndyDCPConnector::getTaskBlendingLevel(int & ret)
//{
//	INDY_DCP_EXEC_CMD_RES_VAR(CMD_GET_TASK_BLEND_RADIUS_LEVEL, int, ret);
//}
