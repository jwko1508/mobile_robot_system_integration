...
class control_gripper():
  ...
  def gripper_initialize(self, sub_function = 0x02, read_or_write = 0x01):
    ...
    while not (isReceived):
      return_command_data, return_data = self.receive_data()
      # print("return_command_data[7] :", return_command_data[7])
      if (return_command_data[7] == 0x00):
        print("initialization completed.")
        isReceived = True
      time.sleep(0.01)
      # print("isReceived: ", isReceived)
      # print("2 return_command_data[7] :", return_command_data[7])
...
if __name__ == '__main__':
  ...
  # waiting_time = 4
  Control_gripper.gripper_initialize(sub_function=0x02, read_or_write=Control_gripper.WRITE)
  # time.sleep(8)

  Control_gripper.set_force_of_gripper(40, Control_gripper.EXTERNAL_DIRECTION)
  time.sleep(1)
  Control_gripper.set_force_of_gripper(35, Control_gripper.INTERNAL_DIRECTION)
  time.sleep(1)
